...
@Tag(name= "Produtos", description = " API REST DE GERENCIAMENTO DE PRODUTO")
@RestController
...
public class ProdutoController {
	...
	public ResponseEntity<Produto> salvaProdutosCpntrol(@RequestBody @Valid Produto produto) {
